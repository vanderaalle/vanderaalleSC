...
QStethoscope2bis {
  ...
  var <window, <view, <scopeView, cycleSlider, yZoomSlider,
      ...
      // added by AV 
      <audioColor, <controlColor, <background;
  ...
  *new {
    arg server, numChannels = 2, index = 0, bufsize = 4096,
        cycle = 1024, rate = \audio, view, 
         // added by AV 
        audioColor = Color.new255(255, 218, 000), controlColor = Color.new255(125, 255, 205), background = Color.black;
  ...
  initQStethoscope { arg server_, parent, bus_, bufsize_, cycle_, audioColor_, controlColor_,
	  background;
    var singleBus;
    ...
    audioColor = audioColor_; 
    controlColor = controlColor_;
    ...
    makeGui = { arg parent;
      ...
      scopeView = QScope2().background_(background);
    ...
    updateColors = {
      var colors;
      bus.do { |b|
        var c = if(b.rate === \audio){audioColor}{controlColor};
